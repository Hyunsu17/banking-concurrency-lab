...
public class TransactionService {
    ...
    public List<Transaction> deposit(Long walletId, Long depositAmount) {
        ...
        // wallet 있는지 확인
        Wallet wallet = walletRepository.findById(walletId).orElseThrow(() -> new IllegalArgumentException("해당 지갑을 찾을 수 없습니다"));
    ...
    public List<Transaction> transfer(Long fromId, Long toId, Long amount) {
        ...
        //TODO Exception 처리 방식 고민
        // wallet 있는지 확인
        Wallet fromWallet = walletRepository.findById(fromId).orElseThrow(() -> new IllegalArgumentException("거래원천 지갑을 찾을 수 없습니다"));

        Wallet toWallet = walletRepository.findById(toId).orElseThrow(() -> new IllegalArgumentException("거래대상 지갑을 찾을 수 없습니다"));
