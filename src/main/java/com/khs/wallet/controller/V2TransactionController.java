...
import com.khs.wallet.service.OptimisticTransactionService;
...
@Tag(name = "낙관적락 트랜잭션 API")
public class V2TransactionController {

    private final OptimisticTransactionService transactionService;
