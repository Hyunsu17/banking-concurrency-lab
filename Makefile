.PHONY: test test-v1 test-v2 test-v3 test-v4 help
...
help:
	...
	@echo ""
	@echo "  make test        전체 순차 실행 (v1 → v2 → v3 → v4, 약 3분)"
	@echo "  make test-v1     v1 비관적락만"
	@echo "  make test-v2     v2 낙관적락만"
...
test-v1:
	k6 run test.js -e VERSION=v1 -e BASE_URL=$(BASE_URL)
